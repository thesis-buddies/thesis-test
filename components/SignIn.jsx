      ...
      <div className="flex flex-col min-h-screen flex-grow justify-center space-y-3">
        <div className=" bg-white p-10 container mx-auto">
          ...
          <div className=" text-xs flex flex-grow flex-col py-8 space-y-2">
            <div>
              <span className="py-1 after:content-['*'] after:ml-0.5 after:text-red-500 font-semibold text-slate-700">
                Phone Number
              </span>
            ...
            <div>
              ...
              <div class="flex relative ">
                ...
                <input
                  type="password"
                  id="password"
                  class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                  name="password"
                  placeholder="**********"
                />
              </div>
